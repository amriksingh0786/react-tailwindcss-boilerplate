...
export default function SwipeCards() {
  ...
  console.log("qqqqqqq", JSON.parse(localStorage.getItem("char"))!==null ? JSON.parse(localStorage.getItem("char")): characters );
  ...
  const outOfFrame = (name) => {
    ...
    console.log(
      "fil",
      JSON.parse(localStorage.getItem("char"))!==null ? JSON.parse(localStorage.getItem("char")).filter(
        (character) => character.name !== name
      ) : "cool"
    );
    setCharacters(JSON.parse(localStorage.getItem("char"))!==null ? JSON.parse(localStorage.getItem("char")).filter(
      (character) => character.name !== name
    ) : charactersState);
  };
